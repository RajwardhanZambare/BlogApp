    ...
    return (
        <div id='navbar' className='bg-[#FAF9F6] w-[69.5vw] h-[12vh] flex fixed top-0 z-10 border-b border-slate-200'>
            ...
            <div id="right" ref={dropDownRef} className='w-[60%] flex justify-evenly items-center relative'>
                ...
                {showDropDown && (
                    <div id="drop-down" className='h-auto w-[12vw] bg-[#F1EFEA] absolute right-7 top-18 rounded-3xl shadow-lg flex flex-col p-4 gap-3'>
                        ...
                        <div className='flex w-full h-[12%]'> {/*elements inside dropdown */}
                            <button className="w-fill flex gap-7 active:scale-95">
                                <div className='pl-1flex items-center justify-center w-[20%]'> {/* icon */}
                        ...
                        <div className='flex w-full gap-4'> {/*elements inside dropdown */}
                            <button className="w-full flex gap-4">
                                ...
                                <div className='flex items-center justify-center w-[80%] break-all'> {/* element name */}
                                    Rajwardhan_4063
                                </div>
                            </button>
                        </div>
